...
import 'package:perpustakaan/controllers/DashboardController.dart';
  ...
  setData(data) {
    if (data is Map) {
      if (data['key'] == ForSetData.forDashboard) {
        setState(() {
          totalBuku = data['payload']['totalBuku'].toString();
          totalStok = data['payload']['totalStok'].toString();
          totalMember = data['payload']['totalMember'].toString();
          totalPegawai = data['payload']['totalPegawai'].toString();
          totalPeminjaman = data['payload']['totalPeminjaman'].toString();
